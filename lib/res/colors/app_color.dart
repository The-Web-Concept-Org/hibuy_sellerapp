...
class AppColors {
  ...
  static const Color red = Color(0xffF53E32);
  static const Color dark = Color(0xff1B262C);

  static Color hintTextDarkGrey = Color(0xff333333).withOpacity(0.50);
  static const Color lightBorderGrey = Color(0xffECECEC);
}
