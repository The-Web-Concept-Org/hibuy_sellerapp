...
class TappableProfileImage extends StatefulWidget {
  ...
  @override
  State<TappableProfileImage> createState() => _TappableProfileImageState();
}

class _TappableProfileImageState extends State<TappableProfileImage> {
  File? _pickedImage;
