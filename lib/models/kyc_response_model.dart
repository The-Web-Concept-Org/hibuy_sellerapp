...
class Seller {
  ...
  factory Seller.fromJson(Map<String, dynamic> json) => Seller(
        ...
        documentsInfo: json['documents_info'] != null ? DocumentsInfo.fromJson(json['documents_info']) : null,
        ...
        statusImages: json['statusImages'] != null ? StatusImages.fromJson(json['statusImages']) : null,
      );
...
class DocumentsInfo {
  ...
  DocumentsInfo({this.step, this.status, this.country, this.province, this.city, this.homeBill});
...
class StatusImages {
  ...
  StatusImages({this.personalInfo, this.storeInfo, this.documentsInfo, this.bankInfo, this.businessInfo});
